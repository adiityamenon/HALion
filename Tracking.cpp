...
int main(int argc, char **argv)
{
    ...
    // Read video
    VideoCapture video("/Videos/Test2.mp4"); 
    ...
    {     
        ...
        // To get the value of duration using the count() member function on the duration object
        ...
        //cv::VideoWriter video("output.avi", cv::VideoWriter::fourcc('M','P','E','G'), 30.00, cv::Size(640,480));
